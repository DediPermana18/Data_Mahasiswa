...
double nilairata(int uts, int uas, int tugas) {
    return (tugas * 0.25) + (uts * 0.35) + (uas * 0.4);
}
double nilaibobotakhirUTS(int uts) {
    return uts * 0.35;
}
double nilaibobotakhirUAS(int uas) {
    return uas * 0.4;
}
double nilaibobotakhirTugas(int tugas) {
    return tugas * 0.25;
}
...
void printMahasiswaData(const Mahasiswa &mhs) {
    ...
    cout << "Tugas: " << mhs.nilaiMhs.tugas << endl << endl;
    cout << "          ** Bobot **" << endl;
